...
export const Layout = ({ children }) => {
    return (
        <div className="min-h-screen relative selection:bg-gold/20 selection:text-gold-light">
            ...
            <div className="relative z-10 container mx-auto px-4 py-8 max-w-5xl">
                ...
                <footer className="mt-12 text-center text-ink-muted text-sm font-serif">
                    <p>© {new Date().getFullYear()} Rivellon Hoy. Escrito por los Escribas de la Costa.</p>
                </footer>
            </div>
        </div>
    );
